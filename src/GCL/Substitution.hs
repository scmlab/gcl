...
import           Syntax.Abstract                ( ElimCase(ElimConstructor)
                                                , Expr(..)
                                                , Mapping
                                                )
...
--
    ...
    Elim e cases l -> do
      cases' <- forM cases $ \(ElimConstructor ctor binders body) ->
        ElimConstructor ctor binders <$> subst mapping body
      return $ Elim e cases' l
